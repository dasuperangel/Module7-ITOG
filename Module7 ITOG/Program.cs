...
namespace SF.Task7.Final
{
        ...
        public class Product
        {
            ...
            public double Cost
            {
                ...
                set
                {
                    ...
                    {
                        Console.WriteLine("У товара нет цены");
                    }
                }
            }
    ...
    class HomeDelivery : Delivery
    {
        ...
        public HomeDelivery()
        {
            Courier = "'Служба доставки Доставка от дяди Вани'";
    ...
    class PickPointDelivery : Delivery
    {
        ...
        {
            Address = "В ближайшом пункте выдачи дяди Вани";
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //Товары
            prod[0] = new Order.Product { nameProduct = "Мужские туфли", typeProduct = "Обувь", cost = 4000.00 };
            ord.AddProduct(prod[0]);

            prod[1] = new Order.Product { nameProduct = "Малиновый пиджак", typeProduct = "Пиджаки", cost = 5500.00 };
            ord.AddProduct(prod[1]);

            prod[2] = new Order.Product { nameProduct = "Малиновые брюки", typeProduct = "Брюки", cost = 3999.99 };
